  ...
  const {
    ...
    defaultValues: async () => {
      ...
      return {
        ...
        construction_type: res.data.construction_type,
              ...
              <VStack spacing={5} align="stretch">
                ...
                <FormControl>
                  ...
                  <Input
                    ...
                    type="text"
                    placeholder="Enter construction_type"
                  />
                ...
                <FormControl>
                  ...
                  />
                  {errors.sector && (
                    <p style={{ color: "red" }}>{errors.sector?.message}</p>
                  )}
                </FormControl>
                ...
                <FormControl>
                  ...
                  {projects?.image && (
                    <img
                      src={fieUrl + "uploads/services/small/" + projects?.image}
